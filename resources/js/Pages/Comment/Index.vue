...
<template>
    <div class="w-1/2 mx-auto p-6">
        ...
        <h1 class="text-2xl font-bold mb-4">Comments List</h1>
        <ul class="space-y-4">
            <li
            ...
            >
                <Link :href="route('comments.show', comment.id)" class="block">
                    <h2 class="text-xl font-bold mb-2">{{ comment.title }}</h2>
                    <div class="text-sm text-gray-500 mb-4 flex justify-between">
                        <span>{{ comment.profile.full_name }}</span>
